...
<html lang="en">
  <head>
    <title>Global Escrow - Home Of Satisfaction</title>
    <meta charset="utf-8">
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="index.html"><img src="images/logo.png" height="60" width="250"></a>
	    		...
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	...
					    	<div class="text">
					    		<span>Email</span>
						    	<span>support@global-escrow.net</span>
						    </div>
					    </div>
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto" style="text-transform: uppercase; ">
	        	...
	        	<li class="nav-item"><a href="transaction.php" class="nav-link">Start A Transaction</a></li>
