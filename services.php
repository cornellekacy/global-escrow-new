    ...
    <section class="ftco-section ftco-no-pb">
			<div class="container">
					...
					<div class="col-md-5 order-md-last wrap-about align-items-stretch">
						<div class="wrap-about-border ftco-animate">
							...
							<div class="text">
								...
								<p>Escrow helps to reduce the risk of a transaction failing. Having a third party hold funds until both parties are satisfied with a transaction. This can be particularly important when using classifieds or other consumer to consumer transactions.</p>
          	...
          	<h2 class="mb-4">Our Main Features</h2>
						<p>Global Escrow as an escrow service provides so many services to its clients. We make buy physical and digital products very easy.</p>
						<div class="row mt-5">
							<div class="col-lg-6">
								<div class="services active text-center">
									...
									<div class="text media-body">
										<h3>Drug Escrow</h3>
										<p>We make buying drugs online very descrete and secure, just create an escrow transaction and let's secure your transaction. We are here for you</p>
									</div>
								</div>
								<div class="services text-center">
									<div class="icon mt-2 d-flex justify-content-center align-items-center"><span class="flaticon-analysis"></span></div>
									<div class="text media-body">
										<h3>Cryto-Currency Escrow</h3>
										<p>Do you trade crypto-currency online, then we got you covered. we make sure the currency you are buying gets to you.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="services text-center">
									...
									<div class="text media-body">
										<h3>Services Escrow</h3>
										<p>do you provide services online or you want to pay for a service, then we are here for you. we cover services escrow what ever the service might be</p>
									</div>
								</div>
								<div class="services text-center">
									...
									<div class="text media-body">
										...
										<p>Jewelries are expensive, that why we take time to understand the agreement with the seller ad buyer before we cover it</p>
									</div>
								</div>
							</div>
						</div>
