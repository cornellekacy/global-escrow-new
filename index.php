      ...
      <div class="slider-item" style="background-image:url(images/bg_1.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-7 ftco-animate">
          	<span class="subheading">Buy Goods And Services Online Safely
Let us make sure it gets to you.</span>
            <h1 class="mb-4">Unique Escrow Services</h1>
            <p><a href="transaction.php" class="btn btn-primary px-4 py-3 mt-3">Start A Transaction</a></p>
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-7 ftco-animate">
            ...
            <h1 class="mb-4">Don't Start an online transaction with out unique escrow</h1>
            <p><a href="transaction.php" class="btn btn-primary px-4 py-3 mt-3">Start A Transaction</a></p>
          </div>
        </div>
        </div>
